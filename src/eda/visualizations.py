...
def plot_class_imbalance(df: pd.DataFrame, target_var: str = 'y', 
                        config_path: str = "config/config.yaml", save: bool = True):
    """
...
def plot_categorical_conversion(df: pd.DataFrame, categorical_vars: list = None,
                               target_var: str = 'y', config_path: str = "config/config.yaml", 
                               save: bool = True):
    """
...
def plot_numerical_analysis(df: pd.DataFrame, config_path: str = "config/config.yaml", 
                           save: bool = True):
    """
    ...
    return {
        ...
        'outlier_count': len(outliers), 'outlier_percentage': len(outliers)/len(df)*100
    }


def plot_correlation_heatmap(df: pd.DataFrame, numerical_vars: list = None,
                            config_path: str = "config/config.yaml", save: bool = True):
    """
...
def plot_seasonality(df: pd.DataFrame, target_var: str = 'y',
                    config_path: str = "config/config.yaml", save: bool = True):
    """
...
def plot_duration_analysis(df: pd.DataFrame, target_var: str = 'y',
                          config_path: str = "config/config.yaml", save: bool = True):
    """
